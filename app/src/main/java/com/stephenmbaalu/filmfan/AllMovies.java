...
public class AllMovies extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(AppUtil.checkInternetConenction(getActivity())){
            new LoadUpcomingAys(getActivity()).execute();
        }else {
    ...
    private class LoadUpcomingAys extends AsyncTask<String, String, JSONObject> {

        private Activity context;
        // private String selectedItem;
        private ProgressDialog progressDialog;

        public LoadUpcomingAys(Activity context) {
        ...
        protected JSONObject doInBackground(String... strings) {
            ...
            String url= AppConstants.APIBASE_URL+"movie/upcoming";

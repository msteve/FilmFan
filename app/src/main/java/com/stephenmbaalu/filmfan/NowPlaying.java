...
public class NowPlaying extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       //
        ...
        if(AppUtil.checkInternetConenction(getActivity())){
            new LoadNowPlaying(getActivity()).execute();
        }else {
    ...
    private class LoadNowPlaying extends AsyncTask<String, String, JSONObject> {

        private Activity context;
       // private String selectedItem;
        private ProgressDialog progressDialog;

        public LoadNowPlaying(Activity context) {
        ...
        protected JSONObject doInBackground(String... strings) {
            ...
            String url= AppConstants.APIBASE_URL+"movie/now_playing";

...
public class TopRated extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(AppUtil.checkInternetConenction(getActivity())){
            new LoadTopratedAys(getActivity()).execute();
        }else {
    ...
    private class LoadTopratedAys extends AsyncTask<String, String, JSONObject> {

        private Activity context;
        // private String selectedItem;
        private ProgressDialog progressDialog;

        public LoadTopratedAys(Activity context) {
        ...
        protected JSONObject doInBackground(String... strings) {
            ...
            String url= AppConstants.APIBASE_URL+"movie/top_rated";
